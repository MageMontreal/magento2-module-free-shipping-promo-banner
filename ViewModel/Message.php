 ...
 */
namespace MageMontreal\FreeShippingPromo\ViewModel;
...
{
    const XML_IS_ENABLED_CONFIG_PATH = 'mm_freeshippingpromo/general/enable';
    const XML_FREE_SHIPPING_THRESHOLD_CONFIG_PATH = 'mm_freeshippingpromo/general/free_shipping_threshold_amount';
    const XML_MESSAGE_DEFAULT_CONFIG_PATH = 'mm_freeshippingpromo/message/message_default';
    const XML_MESSAGE_ITEMS_IN_CART_CONFIG_PATH = 'mm_freeshippingpromo/message/message_items_in_cart';
    const XML_MESSAGE_FREE_SHIPPING_CONFIG_PATH = 'mm_freeshippingpromo/message/message_free_shipping';
